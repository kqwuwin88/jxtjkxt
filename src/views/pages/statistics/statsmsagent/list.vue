        ...
        <div class="content-list-wrap" flex="dir:top" flex-box="1">
            <div class="table-wrap" flex-box="1">
                <el-table :data="tableData" v-if="refresh" class="table-border" ref="multipleTable" height="100%" :summary-method="getSummaries" show-summary>
                    <el-table-column prop="agentName" label="代理商" width=""></el-table-column>
                    <el-table-column prop="portalNum" label="端口数量" width=""></el-table-column>
...
export default {
	...
	methods:{
		...
		queryList(){
            this.tableData = []
            this.refresh = false
			this.$api.smsStatistAgent({...this.formInline,page:this.page}).then( res => { 
